...
// save filters into device constant memory CMEM
...
void seamCarvingByDevice2 (uchar3 * inPixels, int width, int height, int nSeams, uchar3*& outPixels){
	...
	// TODO: Pin host memory regions (allocated by malloc)
