        ...
        uchar3 * outPixels)
{
	...
	{
		float3 outPixel = make_float3(0.0f, 0.0f, 0.0f);
		...
		outPixels[outPixelsR * width + outPixelsC].y = outPixel.y;
		outPixels[outPixelsR * width + outPixelsC].x = outPixel.x;
		outPixels[outPixelsR * width + outPixelsC].z = outPixel.z;
